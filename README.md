# Deteksi Citra Berita Berisi Teks

## What this project is and what it is for

This project is a multimodal fake news detection application for images that contain text. It is designed to classify an input image as either `Fake` or `Real` by combining:
- visual features extracted from the image,
- OCR-extracted text from the image,
- and text processing of the OCR result.

The purpose of the project is to provide a proof-of-concept interactive demo that demonstrates how computer vision and natural language processing can be fused to detect manipulated or misleading news images.
